...
human_stage_comments는 이 과정에서 팀이 남긴 직감·이견·우선순위다. 촉매의 긴장과 질문에 반영하되 검증된 사실로 취급하지 않는다.
...
출력: {"synthesis_possible":true,"catalyst":{"provocation":"","reframe":"","tensions":[""],"discussion_question":""},"contribution":{"요소":["branch id"]},"refusal_reason":null}`,
    {
      ...
      human_stage_comments: humanGuidance,
    },
    { maxTokens: 2600 },
  );
...
human_stage_comments는 팀의 직감·이견·선택 이유다. 재구성의 긴장과 질문에 반영하되 채택 근거를 대체하는 사실로 취급하지 않는다.
